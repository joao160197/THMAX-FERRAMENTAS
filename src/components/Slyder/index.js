...
export function Slyder() {
  return (
    <div className="relative  h-full w-full overflow-hidden">
      <div id="carouselExampleIndicators" className="carousel slide relative  h-full" data-bs-ride="carousel">
        ...
        <div className="carousel-inner relative  h-full">
          <div className="carousel-item active relative float-left  h-full">
            <img className="block w-full h-full object-cover" src={Img1} alt="First slide" />
          </div>
          <div className="carousel-item relative float-left  h-full">
